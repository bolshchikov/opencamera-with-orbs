...
import net.sourceforge.openregistrycamera.LocationSupplier;
import net.sourceforge.openregistrycamera.preview.Preview;
import net.sourceforge.openregistrycamera.preview.VideoQualityHandler;
import net.sourceforge.openregistrycamera.TextFormatter;
import net.sourceforge.openregistrycamera.ui.DrawPreview;
